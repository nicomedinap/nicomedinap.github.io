...
<body>
    ...
    <script>
        ...
        // Caché de lentes visibles: se recalcula una vez por frame (en draw()),
        ...
        function updateLensParameters() {
            ...
            lenses[currentLensIndex].radiusSq = lenses[currentLensIndex].radius * lenses[currentLensIndex].radius;
        }
        ...
        function draw() {
            // Se filtra UNA vez por frame, no una vez por rayo/paso.
            // Con pocos lentes esto es barato, y evita miles de chequeos
            // repetidos de `.visible` dentro de castRay.
            activeLensesCache = lenses.filter(l => l.visible);
