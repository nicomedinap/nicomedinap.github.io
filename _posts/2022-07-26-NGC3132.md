...
Entonces, si simbolizamos los canales como (i,j,k) = (0,1,2), podemos formar las siguientes imágenes usanda cada uno de sus órdenes:
...
Si hacen click sobre cada una de las nebulosas, pueden descargar la imágenes ;)
