...
const chileanCities = {
  ...
  "Concón":           { lat: -32.917,  lon: -71.5167, region: "V Región",   altitude: 136 },
  "Quintero":         { lat: -32.7834, lon: -71.5334, region: "V Región",   altitude: 54  },
  "Algarrobo":        { lat: -33.3693, lon: -71.6682, region: "V Región",   altitude: 13  },
  "El Quisco":        { lat: -33.4,    lon: -71.7,    region: "V Región",   altitude: 147 },
  "San Antonio":      { lat: -33.5809, lon: -71.6132, region: "V Región",   altitude: 4   },
  "Cartagena":        { lat: -33.55,   lon: -71.6,    region: "V Región",   altitude: 140 },
